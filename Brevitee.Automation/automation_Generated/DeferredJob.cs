...
namespace Brevitee.Automation.Data
{
	...
	[Serializable]
	[Brevitee.Data.Table("DeferredJob", "Automation")]
	public partial class DeferredJob: Dao
	{
		...
		public DeferredJob(DataRow data): base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		}
...
﻿	// property:JobDirectory, columnName:JobDirectory	
	[Brevitee.Data.Column(Name="JobDirectory", DbDataType="VarChar", MaxLength="4000", AllowNull=false)]
...
﻿	// property:LastStepNumber, columnName:LastStepNumber	
	[Brevitee.Data.Column(Name="LastStepNumber", DbDataType="VarChar", MaxLength="4000", AllowNull=false)]
