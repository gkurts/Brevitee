...
namespace Brevitee.Automation.Data
{
	...
	[Serializable]
	[Brevitee.Data.Table("RunningJob", "Automation")]
	public partial class RunningJob: Dao
	{
		...
		public RunningJob(DataRow data): base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		}
...
﻿	// property:BuildJobId, columnName:BuildJobId	
	[Brevitee.Data.Column(Name="BuildJobId", DbDataType="BigInt", MaxLength="19", AllowNull=true)]
