...
namespace Brevitee.Automation.ContinuousIntegration.Data
{
	...
	[Serializable]
	[Brevitee.Data.Table("BuildJob", "ContinuousIntegration")]
	public partial class BuildJob: Dao
	{
		...
		{
﻿
            this.ChildCollections.Add("BuildResult_BuildJobId", new BuildResultCollection(Database.GetQuery<BuildResultColumns, BuildResult>((c) => c.BuildJobId == this.Id), this, "BuildJobId"));							
		}
