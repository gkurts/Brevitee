...
﻿
	...
	public class CartItemQueryContext
	{
			...
			{
				return Brevitee.Data.Tests.CartItem.Where(where, db);
			}
			...
			{
				return Brevitee.Data.Tests.CartItem.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<CartItemColumns> where, Database db = null)
			{
				return Brevitee.Data.Tests.CartItem.Count(where, db);
			}
	}
	...
	public class ListItemQueryContext
	{
			...
			{
				return Brevitee.Data.Tests.ListItem.Where(where, db);
			}
			...
			{
				return Brevitee.Data.Tests.ListItem.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ListItemColumns> where, Database db = null)
			{
				return Brevitee.Data.Tests.ListItem.Count(where, db);
			}
	}
