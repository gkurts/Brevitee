...
namespace Brevitee.Stickerize.Business.Data
{
	...
	public partial class Image: Dao
	{
		...
		{
﻿
            this.ChildCollections.Add("Stickerizer_ImageId", new StickerizerCollection(Database.GetQuery<StickerizerColumns, Stickerizer>((c) => c.ImageId == this.Id), this, "ImageId"));	﻿
            this.ChildCollections.Add("Stickerizee_ImageId", new StickerizeeCollection(Database.GetQuery<StickerizeeColumns, Stickerizee>((c) => c.ImageId == this.Id), this, "ImageId"));	﻿
            this.ChildCollections.Add("Sticker_ImageId", new StickerCollection(Database.GetQuery<StickerColumns, Sticker>((c) => c.ImageId == this.Id), this, "ImageId"));							
		}
