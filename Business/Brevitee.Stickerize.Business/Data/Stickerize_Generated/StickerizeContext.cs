...
﻿
	public class LoginTimeQueryContext
	{
			...
			{
				return Brevitee.Stickerize.Business.Data.LoginTime.Where(where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.LoginTime.Where(where, orderBy, db);
			}

			public LoginTime OneWhere(WhereDelegate<LoginTimeColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.LoginTime.OneWhere(where, db);
			}
		
			public LoginTime FirstOneWhere(WhereDelegate<LoginTimeColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.LoginTime.FirstOneWhere(where, db);
			}

			public LoginTimeCollection Top(int count, WhereDelegate<LoginTimeColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.LoginTime.Top(count, where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.LoginTime.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<LoginTimeColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.LoginTime.Count(where, db);
			}
	}
	...
	public class StickerizerQueryContext
	{
			...
			{
				return Brevitee.Stickerize.Business.Data.Stickerizer.Where(where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.Stickerizer.Where(where, orderBy, db);
			}

			public Stickerizer OneWhere(WhereDelegate<StickerizerColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerizer.OneWhere(where, db);
			}
		
			public Stickerizer FirstOneWhere(WhereDelegate<StickerizerColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerizer.FirstOneWhere(where, db);
			}

			public StickerizerCollection Top(int count, WhereDelegate<StickerizerColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerizer.Top(count, where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.Stickerizer.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<StickerizerColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerizer.Count(where, db);
			}
	}
	...
	public class StickerizeeQueryContext
	{
			...
			{
				return Brevitee.Stickerize.Business.Data.Stickerizee.Where(where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.Stickerizee.Where(where, orderBy, db);
			}

			public Stickerizee OneWhere(WhereDelegate<StickerizeeColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerizee.OneWhere(where, db);
			}
		
			public Stickerizee FirstOneWhere(WhereDelegate<StickerizeeColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerizee.FirstOneWhere(where, db);
			}

			public StickerizeeCollection Top(int count, WhereDelegate<StickerizeeColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerizee.Top(count, where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.Stickerizee.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<StickerizeeColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerizee.Count(where, db);
			}
	}
	...
	public class StickerizableQueryContext
	{
			...
			{
				return Brevitee.Stickerize.Business.Data.Stickerizable.Where(where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.Stickerizable.Where(where, orderBy, db);
			}

			public Stickerizable OneWhere(WhereDelegate<StickerizableColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerizable.OneWhere(where, db);
			}
		
			public Stickerizable FirstOneWhere(WhereDelegate<StickerizableColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerizable.FirstOneWhere(where, db);
			}

			public StickerizableCollection Top(int count, WhereDelegate<StickerizableColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerizable.Top(count, where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.Stickerizable.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<StickerizableColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerizable.Count(where, db);
			}
	}
	...
	public class StickerizableListQueryContext
	{
			...
			{
				return Brevitee.Stickerize.Business.Data.StickerizableList.Where(where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.StickerizableList.Where(where, orderBy, db);
			}

			public StickerizableList OneWhere(WhereDelegate<StickerizableListColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.StickerizableList.OneWhere(where, db);
			}
		
			public StickerizableList FirstOneWhere(WhereDelegate<StickerizableListColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.StickerizableList.FirstOneWhere(where, db);
			}

			public StickerizableListCollection Top(int count, WhereDelegate<StickerizableListColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.StickerizableList.Top(count, where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.StickerizableList.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<StickerizableListColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.StickerizableList.Count(where, db);
			}
	}
	...
	public class StickerQueryContext
	{
			...
			{
				return Brevitee.Stickerize.Business.Data.Sticker.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<StickerColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Sticker.Count(where, db);
			}
	}
	...
	public class StickerizationQueryContext
	{
			...
			{
				return Brevitee.Stickerize.Business.Data.Stickerization.Where(where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.Stickerization.Where(where, orderBy, db);
			}

			public Stickerization OneWhere(WhereDelegate<StickerizationColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerization.OneWhere(where, db);
			}
		
			public Stickerization FirstOneWhere(WhereDelegate<StickerizationColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerization.FirstOneWhere(where, db);
			}

			public StickerizationCollection Top(int count, WhereDelegate<StickerizationColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerization.Top(count, where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.Stickerization.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<StickerizationColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.Stickerization.Count(where, db);
			}
	}
	...
	public class SubSectionQueryContext
	{
			...
			{
				return Brevitee.Stickerize.Business.Data.SubSection.Where(where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.SubSection.Where(where, orderBy, db);
			}

			public SubSection OneWhere(WhereDelegate<SubSectionColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.SubSection.OneWhere(where, db);
			}
		
			public SubSection FirstOneWhere(WhereDelegate<SubSectionColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.SubSection.FirstOneWhere(where, db);
			}

			public SubSectionCollection Top(int count, WhereDelegate<SubSectionColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.SubSection.Top(count, where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.SubSection.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<SubSectionColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.SubSection.Count(where, db);
			}
	}
	...
	public class StickerizerStickerizeeQueryContext
	{
			...
			{
				return Brevitee.Stickerize.Business.Data.StickerizerStickerizee.Where(where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.StickerizerStickerizee.Where(where, orderBy, db);
			}

			public StickerizerStickerizee OneWhere(WhereDelegate<StickerizerStickerizeeColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.StickerizerStickerizee.OneWhere(where, db);
			}
		
			public StickerizerStickerizee FirstOneWhere(WhereDelegate<StickerizerStickerizeeColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.StickerizerStickerizee.FirstOneWhere(where, db);
			}

			public StickerizerStickerizeeCollection Top(int count, WhereDelegate<StickerizerStickerizeeColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.StickerizerStickerizee.Top(count, where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.StickerizerStickerizee.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<StickerizerStickerizeeColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.StickerizerStickerizee.Count(where, db);
			}
	}
	...
	public class StickerizableListStickerizableQueryContext
	{
			...
			{
				return Brevitee.Stickerize.Business.Data.StickerizableListStickerizable.Where(where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.StickerizableListStickerizable.Where(where, orderBy, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.StickerizableListStickerizable.OneWhere(where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.StickerizableListStickerizable.FirstOneWhere(where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.StickerizableListStickerizable.Top(count, where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.StickerizableListStickerizable.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<StickerizableListStickerizableColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.StickerizableListStickerizable.Count(where, db);
			}
	}
	...
	public class SubSectionStickerizableQueryContext
	{
			...
			{
				return Brevitee.Stickerize.Business.Data.SubSectionStickerizable.Where(where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.SubSectionStickerizable.Where(where, orderBy, db);
			}

			public SubSectionStickerizable OneWhere(WhereDelegate<SubSectionStickerizableColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.SubSectionStickerizable.OneWhere(where, db);
			}
		
			public SubSectionStickerizable FirstOneWhere(WhereDelegate<SubSectionStickerizableColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.SubSectionStickerizable.FirstOneWhere(where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.SubSectionStickerizable.Top(count, where, db);
			}
			...
			{
				return Brevitee.Stickerize.Business.Data.SubSectionStickerizable.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<SubSectionStickerizableColumns> where, Database db = null)
			{
				return Brevitee.Stickerize.Business.Data.SubSectionStickerizable.Count(where, db);
			}
	}
