...
namespace Brevitee.DaoRef
{
	...
	[Serializable]
	[Brevitee.Data.Table("DaoReferenceObjectWithForeignKey", "DaoRef")]
...
﻿	// start DaoReferenceObjectId -> DaoReferenceObjectId
	...
	public DaoReferenceObject DaoReferenceObjectOfDaoReferenceObjectId
	{
		get
		{
			...
			{
				_daoReferenceObjectOfDaoReferenceObjectId = Brevitee.DaoRef.DaoReferenceObject.OneWhere(c => c.KeyColumn == this.DaoReferenceObjectId, this.Database);
			}
		...
		public static DaoReferenceObjectWithForeignKeyCollection LoadAll(Database database = null)
		{
			...
			var results = new DaoReferenceObjectWithForeignKeyCollection(sql.GetDataTable(db));
			results.Database = db;
			return results;
		}
