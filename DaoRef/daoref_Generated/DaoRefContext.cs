...
﻿
	...
	public class TestTableQueryContext
	{
			...
			{
				return Brevitee.DaoRef.TestTable.Where(where, db);
			}
			...
			{
				return Brevitee.DaoRef.TestTable.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<TestTableColumns> where, Database db = null)
			{
				return Brevitee.DaoRef.TestTable.Count(where, db);
			}
	}
	...
	public class TestFkTableQueryContext
	{
			...
			{
				return Brevitee.DaoRef.TestFkTable.Where(where, db);
			}
			...
			{
				return Brevitee.DaoRef.TestFkTable.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<TestFkTableColumns> where, Database db = null)
			{
				return Brevitee.DaoRef.TestFkTable.Count(where, db);
			}
	}
	...
	public class DaoReferenceObjectQueryContext
	{
			...
			{
				return Brevitee.DaoRef.DaoReferenceObject.Where(where, db);
			}
			...
			{
				return Brevitee.DaoRef.DaoReferenceObject.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<DaoReferenceObjectColumns> where, Database db = null)
			{
				return Brevitee.DaoRef.DaoReferenceObject.Count(where, db);
			}
	}
	...
	public class DaoReferenceObjectWithForeignKeyQueryContext
	{
			...
			{
				return Brevitee.DaoRef.DaoReferenceObjectWithForeignKey.Where(where, db);
			}
			...
			{
				return Brevitee.DaoRef.DaoReferenceObjectWithForeignKey.Where(where, orderBy, db);
			}
			...
			{
				return Brevitee.DaoRef.DaoReferenceObjectWithForeignKey.OneWhere(where, db);
			}
			...
			{
				return Brevitee.DaoRef.DaoReferenceObjectWithForeignKey.FirstOneWhere(where, db);
			}
			...
			{
				return Brevitee.DaoRef.DaoReferenceObjectWithForeignKey.Top(count, where, db);
			}
			...
			{
				return Brevitee.DaoRef.DaoReferenceObjectWithForeignKey.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<DaoReferenceObjectWithForeignKeyColumns> where, Database db = null)
			{
				return Brevitee.DaoRef.DaoReferenceObjectWithForeignKey.Count(where, db);
			}
	}
	...
	public class LeftRightQueryContext
	{
			...
			{
				return Brevitee.DaoRef.LeftRight.Where(where, db);
			}
			...
			{
				return Brevitee.DaoRef.LeftRight.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<LeftRightColumns> where, Database db = null)
			{
				return Brevitee.DaoRef.LeftRight.Count(where, db);
			}
	}
