...
namespace Brevitee.DaoRef
{
	...
	public partial class TestTable: Dao
	{
		...
		public TestTable(DataRow data): base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		}
		...
		{
﻿
            this.ChildCollections.Add("TestFkTable_TestTableId", new TestFkTableCollection(Database.GetQuery<TestFkTableColumns, TestFkTable>((c) => c.TestTableId == this.Id), this, "TestTableId"));							
		}
