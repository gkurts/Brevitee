...
namespace Brevitee.DaoRef
{
	...
	[Serializable]
	[Brevitee.Data.Table("LeftRight", "DaoRef")]
	public partial class LeftRight: Dao
	{
		...
		public LeftRight(DataRow data): base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		}
...
﻿	// start LeftId -> LeftId
	...
	public Left LeftOfLeftId
	{
		get
		{
			...
			{
				_leftOfLeftId = Brevitee.DaoRef.Left.OneWhere(c => c.KeyColumn == this.LeftId, this.Database);
			}
...
﻿	// start RightId -> RightId
	...
	public Right RightOfRightId
	{
		get
		{
			...
			{
				_rightOfRightId = Brevitee.DaoRef.Right.OneWhere(c => c.KeyColumn == this.RightId, this.Database);
			}
