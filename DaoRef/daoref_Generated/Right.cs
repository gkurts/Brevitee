...
namespace Brevitee.DaoRef
{
	...
	[Serializable]
	[Brevitee.Data.Table("Right", "DaoRef")]
	public partial class Right: Dao
	{
		...
		public Right(DataRow data): base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		}
		...
		{
﻿
            this.ChildCollections.Add("LeftRight_RightId", new LeftRightCollection(Database.GetQuery<LeftRightColumns, LeftRight>((c) => c.RightId == this.Id), this, "RightId"));							﻿
