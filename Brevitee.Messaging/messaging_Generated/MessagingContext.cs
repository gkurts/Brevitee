...
﻿
	public class EmailMessageQueryContext
	{
			...
			{
				return Brevitee.Messaging.Data.EmailMessage.Where(where, db);
			}
			...
			{
				return Brevitee.Messaging.Data.EmailMessage.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<EmailMessageColumns> where, Database db = null)
			{
				return Brevitee.Messaging.Data.EmailMessage.Count(where, db);
			}
	}
	...
	public class DirectMessageQueryContext
	{
			...
			{
				return Brevitee.Messaging.Data.DirectMessage.Where(where, db);
			}
			...
			{
				return Brevitee.Messaging.Data.DirectMessage.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<DirectMessageColumns> where, Database db = null)
			{
				return Brevitee.Messaging.Data.DirectMessage.Count(where, db);
			}
	}
	...
	public class MessageQueryContext
	{
			...
			{
				return Brevitee.Messaging.Data.Message.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<MessageColumns> where, Database db = null)
			{
				return Brevitee.Messaging.Data.Message.Count(where, db);
			}
	}
