...
namespace Brevitee.Messaging.Data
{
	...
	[Serializable]
	[Brevitee.Data.Table("Message", "Messaging")]
	public partial class Message: Dao
	{
		...
		{
﻿
            this.ChildCollections.Add("DirectMessage_MessageId", new DirectMessageCollection(Database.GetQuery<DirectMessageColumns, DirectMessage>((c) => c.MessageId == this.Id), this, "MessageId"));							
		}
...
﻿	// property:CreatedDate, columnName:CreatedDate	
	[Brevitee.Data.Column(Name="CreatedDate", DbDataType="DateTime", MaxLength="8", AllowNull=false)]
...
﻿	// property:From, columnName:From	
	[Brevitee.Data.Column(Name="From", DbDataType="VarChar", MaxLength="4000", AllowNull=false)]
	public string From
	{
		get
		{
...
﻿	// property:FromEmail, columnName:FromEmail	
	[Brevitee.Data.Column(Name="FromEmail", DbDataType="VarChar", MaxLength="4000", AllowNull=false)]
...
﻿	// property:Subject, columnName:Subject	
	[Brevitee.Data.Column(Name="Subject", DbDataType="VarChar", MaxLength="4000", AllowNull=true)]
...
﻿	// property:Body, columnName:Body	
	[Brevitee.Data.Column(Name="Body", DbDataType="VarChar", MaxLength="4000", AllowNull=false)]
	public string Body
	{
		get
		{
