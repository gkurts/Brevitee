...
namespace Brevitee.Exegete
{
	...
	[Serializable]
	[Brevitee.Data.Table("Translation", "Exegete")]
	public partial class Translation: Dao
	{
		...
		public Translation(DataRow data): base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		}
...
﻿	// property:TranslatorUuid, columnName:TranslatorUuid	
	[Brevitee.Data.Column(Name="TranslatorUuid", DbDataType="VarChar", MaxLength="4000", AllowNull=false)]
...
﻿	// start TextId -> TextId
	...
	public Text TextOfTextId
	{
		get
		{
			...
			{
				_textOfTextId = Brevitee.Exegete.Text.OneWhere(c => c.KeyColumn == this.TextId);
			}
...
﻿	// start LanguageId -> LanguageId
	...
	public Language LanguageOfLanguageId
	{
		get
		{
			...
			{
				_languageOfLanguageId = Brevitee.Exegete.Language.OneWhere(c => c.KeyColumn == this.LanguageId);
			}
