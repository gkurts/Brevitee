...
namespace Brevitee.Exegete
{
	...
	[Serializable]
	[Brevitee.Data.Table("Text", "Exegete")]
	public partial class Text: Dao
	{
		...
		public Text(DataRow data): base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		}
...
﻿	// property:LanguageId, columnName:LanguageId	
	[Brevitee.Data.Column(Name="LanguageId", DbDataType="BigInt", MaxLength="19", AllowNull=true)]
