...
namespace Brevitee.Shop
{
	...
	[Serializable]
	[Brevitee.Data.Table("Shopper", "Shop")]
	public partial class Shopper: Dao
	{
		...
		public Shopper(DataRow data): base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		}
		...
		{
﻿
            this.ChildCollections.Add("ShoppingCart_ShopperId", new ShoppingCartCollection(Database.GetQuery<ShoppingCartColumns, ShoppingCart>((c) => c.ShopperId == this.Id), this, "ShopperId"));							
		}
