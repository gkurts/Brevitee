...
﻿
	public class CurrencyQueryContext
	{
			...
			{
				return Brevitee.Shop.Currency.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.Currency.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<CurrencyColumns> where, Database db = null)
			{
				return Brevitee.Shop.Currency.Count(where, db);
			}
	}
	...
	public class CurrencyCountryQueryContext
	{
			...
			{
				return Brevitee.Shop.CurrencyCountry.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.CurrencyCountry.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<CurrencyCountryColumns> where, Database db = null)
			{
				return Brevitee.Shop.CurrencyCountry.Count(where, db);
			}
	}
	...
	public class PromotionEffectsQueryContext
	{
			...
			{
				return Brevitee.Shop.PromotionEffects.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.PromotionEffects.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<PromotionEffectsColumns> where, Database db = null)
			{
				return Brevitee.Shop.PromotionEffects.Count(where, db);
			}
	}
	...
	public class PromotionQueryContext
	{
			...
			{
				return Brevitee.Shop.Promotion.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.Promotion.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<PromotionColumns> where, Database db = null)
			{
				return Brevitee.Shop.Promotion.Count(where, db);
			}
	}
	...
	public class PromotionEffectQueryContext
	{
			...
			{
				return Brevitee.Shop.PromotionEffect.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.PromotionEffect.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<PromotionEffectColumns> where, Database db = null)
			{
				return Brevitee.Shop.PromotionEffect.Count(where, db);
			}
	}
	...
	public class PromotionConditionQueryContext
	{
			...
			{
				return Brevitee.Shop.PromotionCondition.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.PromotionCondition.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<PromotionConditionColumns> where, Database db = null)
			{
				return Brevitee.Shop.PromotionCondition.Count(where, db);
			}
	}
	...
	public class ShopperQueryContext
	{
			...
			{
				return Brevitee.Shop.Shopper.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ShopperColumns> where, Database db = null)
			{
				return Brevitee.Shop.Shopper.Count(where, db);
			}
	}
	...
	public class ShoppingCartQueryContext
	{
			...
			{
				return Brevitee.Shop.ShoppingCart.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.ShoppingCart.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ShoppingCartColumns> where, Database db = null)
			{
				return Brevitee.Shop.ShoppingCart.Count(where, db);
			}
	}
	...
	public class ShoppingCartItemQueryContext
	{
			...
			{
				return Brevitee.Shop.ShoppingCartItem.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.ShoppingCartItem.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ShoppingCartItemColumns> where, Database db = null)
			{
				return Brevitee.Shop.ShoppingCartItem.Count(where, db);
			}
	}
	...
	public class ShoppingListQueryContext
	{
			...
			{
				return Brevitee.Shop.ShoppingList.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.ShoppingList.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ShoppingListColumns> where, Database db = null)
			{
				return Brevitee.Shop.ShoppingList.Count(where, db);
			}
	}
	...
	public class ShopItemQueryContext
	{
			...
			{
				return Brevitee.Shop.ShopItem.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.ShopItem.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ShopItemColumns> where, Database db = null)
			{
				return Brevitee.Shop.ShopItem.Count(where, db);
			}
	}
	...
	public class ShopItemAttributeQueryContext
	{
			...
			{
				return Brevitee.Shop.ShopItemAttribute.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.ShopItemAttribute.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ShopItemAttributeColumns> where, Database db = null)
			{
				return Brevitee.Shop.ShopItemAttribute.Count(where, db);
			}
	}
	...
	public class ShopItemAttributeValueQueryContext
	{
			...
			{
				return Brevitee.Shop.ShopItemAttributeValue.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.ShopItemAttributeValue.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ShopItemAttributeValueColumns> where, Database db = null)
			{
				return Brevitee.Shop.ShopItemAttributeValue.Count(where, db);
			}
	}
	...
	public class ShoppingListShopItemQueryContext
	{
			...
			{
				return Brevitee.Shop.ShoppingListShopItem.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.ShoppingListShopItem.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ShoppingListShopItemColumns> where, Database db = null)
			{
				return Brevitee.Shop.ShoppingListShopItem.Count(where, db);
			}
	}
	...
	public class ShopShopItemQueryContext
	{
			...
			{
				return Brevitee.Shop.ShopShopItem.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.ShopShopItem.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ShopShopItemColumns> where, Database db = null)
			{
				return Brevitee.Shop.ShopShopItem.Count(where, db);
			}
	}
	...
	public class ShopItemShopItemAttributeQueryContext
	{
			...
			{
				return Brevitee.Shop.ShopItemShopItemAttribute.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.ShopItemShopItemAttribute.Top(count, where, db);
			}
			...
			{
				return Brevitee.Shop.ShopItemShopItemAttribute.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ShopItemShopItemAttributeColumns> where, Database db = null)
			{
				return Brevitee.Shop.ShopItemShopItemAttribute.Count(where, db);
			}
	}
	...
	public class ShopPromotionQueryContext
	{
			...
			{
				return Brevitee.Shop.ShopPromotion.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.ShopPromotion.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ShopPromotionColumns> where, Database db = null)
			{
				return Brevitee.Shop.ShopPromotion.Count(where, db);
			}
	}
	...
	public class ShopItemPromotionQueryContext
	{
			...
			{
				return Brevitee.Shop.ShopItemPromotion.Where(where, db);
			}
			...
			{
				return Brevitee.Shop.ShopItemPromotion.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ShopItemPromotionColumns> where, Database db = null)
			{
				return Brevitee.Shop.ShopItemPromotion.Count(where, db);
			}
	}
