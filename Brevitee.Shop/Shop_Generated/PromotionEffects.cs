...
namespace Brevitee.Shop
{
	...
	[Serializable]
	[Brevitee.Data.Table("PromotionEffects", "Shop")]
	public partial class PromotionEffects: Dao
	{
		...
		public PromotionEffects(DataRow data): base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		}
		...
		{
﻿
            this.ChildCollections.Add("PromotionEffect_PromotionEffectsId", new PromotionEffectCollection(Database.GetQuery<PromotionEffectColumns, PromotionEffect>((c) => c.PromotionEffectsId == this.Id), this, "PromotionEffectsId"));							
		}
