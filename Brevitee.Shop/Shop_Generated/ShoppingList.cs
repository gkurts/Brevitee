...
namespace Brevitee.Shop
{
	...
	[Serializable]
	[Brevitee.Data.Table("ShoppingList", "Shop")]
	public partial class ShoppingList: Dao
	{
		...
		public ShoppingList(DataRow data): base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		}
		...
		{
﻿
            this.ChildCollections.Add("ShoppingListShopItem_ShoppingListId", new ShoppingListShopItemCollection(Database.GetQuery<ShoppingListShopItemColumns, ShoppingListShopItem>((c) => c.ShoppingListId == this.Id), this, "ShoppingListId"));				﻿
