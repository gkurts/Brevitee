...
namespace Brevitee.Analytics
{
	...
	[Serializable]
	[Brevitee.Data.Table("Category", "Analytics")]
	public partial class Category: Dao
	{
		...
		{
﻿
            this.ChildCollections.Add("Feature_CategoryId", new FeatureCollection(Database.GetQuery<FeatureColumns, Feature>((c) => c.CategoryId == this.Id), this, "CategoryId"));							
		}
...
﻿	// property:DocumentCount, columnName:DocumentCount	
	[Brevitee.Data.Column(Name="DocumentCount", DbDataType="BigInt", MaxLength="19", AllowNull=false)]
