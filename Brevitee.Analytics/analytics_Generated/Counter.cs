...
namespace Brevitee.Analytics
{
	...
	[Serializable]
	[Brevitee.Data.Table("Counter", "Analytics")]
	public partial class Counter: Dao
	{
		...
		{
﻿
            this.ChildCollections.Add("MethodCounter_CounterId", new MethodCounterCollection(Database.GetQuery<MethodCounterColumns, MethodCounter>((c) => c.CounterId == this.Id), this, "CounterId"));	﻿
            this.ChildCollections.Add("LoadCounter_CounterId", new LoadCounterCollection(Database.GetQuery<LoadCounterColumns, LoadCounter>((c) => c.CounterId == this.Id), this, "CounterId"));	﻿
            this.ChildCollections.Add("ClickCounter_CounterId", new ClickCounterCollection(Database.GetQuery<ClickCounterColumns, ClickCounter>((c) => c.CounterId == this.Id), this, "CounterId"));	﻿
            this.ChildCollections.Add("LoginCounter_CounterId", new LoginCounterCollection(Database.GetQuery<LoginCounterColumns, LoginCounter>((c) => c.CounterId == this.Id), this, "CounterId"));							
		}
