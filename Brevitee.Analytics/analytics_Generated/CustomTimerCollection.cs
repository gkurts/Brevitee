...
namespace Brevitee.Analytics
{
    ...
    { 
		...
		public CustomTimerCollection(Database db, DataTable table, Dao dao = null, string rc = null) : base(db, table, dao, rc) { }
		public CustomTimerCollection(DataTable table, Dao dao = null, string rc = null) : base(table, dao, rc) { }
		public CustomTimerCollection(Query<CustomTimerColumns, CustomTimer> q, Dao dao = null, string rc = null) : base(q, dao, rc) { }
