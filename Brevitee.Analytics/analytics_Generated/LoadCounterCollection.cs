...
namespace Brevitee.Analytics
{
    ...
    { 
		...
		public LoadCounterCollection(Database db, DataTable table, Dao dao = null, string rc = null) : base(db, table, dao, rc) { }
		public LoadCounterCollection(DataTable table, Dao dao = null, string rc = null) : base(table, dao, rc) { }
		public LoadCounterCollection(Query<LoadCounterColumns, LoadCounter> q, Dao dao = null, string rc = null) : base(q, dao, rc) { }
