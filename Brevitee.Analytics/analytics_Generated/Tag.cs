...
namespace Brevitee.Analytics
{
	...
	public partial class Tag: Dao
	{
		...
		{
﻿
            this.ChildCollections.Add("UrlTag_TagId", new UrlTagCollection(Database.GetQuery<UrlTagColumns, UrlTag>((c) => c.TagId == this.Id), this, "TagId"));	﻿
            this.ChildCollections.Add("ImageTag_TagId", new ImageTagCollection(Database.GetQuery<ImageTagColumns, ImageTag>((c) => c.TagId == this.Id), this, "TagId"));							﻿
