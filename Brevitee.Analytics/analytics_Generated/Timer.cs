...
namespace Brevitee.Analytics
{
	...
	[Serializable]
	[Brevitee.Data.Table("Timer", "Analytics")]
	public partial class Timer: Dao
	{
		...
		{
﻿
            this.ChildCollections.Add("MethodTimer_TimerId", new MethodTimerCollection(Database.GetQuery<MethodTimerColumns, MethodTimer>((c) => c.TimerId == this.Id), this, "TimerId"));	﻿
            this.ChildCollections.Add("LoadTimer_TimerId", new LoadTimerCollection(Database.GetQuery<LoadTimerColumns, LoadTimer>((c) => c.TimerId == this.Id), this, "TimerId"));	﻿
            this.ChildCollections.Add("CustomTimer_TimerId", new CustomTimerCollection(Database.GetQuery<CustomTimerColumns, CustomTimer>((c) => c.TimerId == this.Id), this, "TimerId"));							
		}
