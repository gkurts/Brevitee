...
namespace Brevitee.Analytics
{
	...
	public partial class UserIdentifier: Dao
	{
		...
		{
﻿
            this.ChildCollections.Add("ClickCounter_UserIdentifierId", new ClickCounterCollection(Database.GetQuery<ClickCounterColumns, ClickCounter>((c) => c.UserIdentifierId == this.Id), this, "UserIdentifierId"));	﻿
            this.ChildCollections.Add("LoginCounter_UserIdentifierId", new LoginCounterCollection(Database.GetQuery<LoginCounterColumns, LoginCounter>((c) => c.UserIdentifierId == this.Id), this, "UserIdentifierId"));							
		}
