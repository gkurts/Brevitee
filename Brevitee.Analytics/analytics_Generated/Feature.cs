...
﻿	// property:FeatureToCategoryCount, columnName:FeatureToCategoryCount	
	[Brevitee.Data.Column(Name="FeatureToCategoryCount", DbDataType="BigInt", MaxLength="19", AllowNull=false)]
...
﻿	// start CategoryId -> CategoryId
	...
	public Category CategoryOfCategoryId
	{
		get
		{
			...
			{
				_categoryOfCategoryId = Brevitee.Analytics.Category.OneWhere(c => c.KeyColumn == this.CategoryId);
			}
