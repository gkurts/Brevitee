...
﻿
	public class CategoryQueryContext
	{
			...
			{
				return Brevitee.Analytics.Category.Where(where, db);
			}
			...
			{
				return Brevitee.Analytics.Category.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<CategoryColumns> where, Database db = null)
			{
				return Brevitee.Analytics.Category.Count(where, db);
			}
	}
	...
	public class FeatureQueryContext
	{
			...
			{
				return Brevitee.Analytics.Feature.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<FeatureColumns> where, Database db = null)
			{
				return Brevitee.Analytics.Feature.Count(where, db);
			}
	}
	...
	public class CrawlerQueryContext
	{
			...
			{
				return Brevitee.Analytics.Crawler.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<CrawlerColumns> where, Database db = null)
			{
				return Brevitee.Analytics.Crawler.Count(where, db);
			}
	}
	...
	public class ProtocolQueryContext
	{
			...
			{
				return Brevitee.Analytics.Protocol.Where(where, db);
			}
			...
			{
				return Brevitee.Analytics.Protocol.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ProtocolColumns> where, Database db = null)
			{
				return Brevitee.Analytics.Protocol.Count(where, db);
			}
	}
	...
	public class QueryStringQueryContext
	{
			...
			{
				return Brevitee.Analytics.QueryString.Where(where, db);
			}
			...
			{
				return Brevitee.Analytics.QueryString.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<QueryStringColumns> where, Database db = null)
			{
				return Brevitee.Analytics.QueryString.Count(where, db);
			}
	}
	...
	public class FragmentQueryContext
	{
			...
			{
				return Brevitee.Analytics.Fragment.Where(where, db);
			}
			...
			{
				return Brevitee.Analytics.Fragment.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<FragmentColumns> where, Database db = null)
			{
				return Brevitee.Analytics.Fragment.Count(where, db);
			}
	}
	...
	public class MethodTimerQueryContext
	{
			...
			{
				return Brevitee.Analytics.MethodTimer.Where(where, db);
			}
			...
			{
				return Brevitee.Analytics.MethodTimer.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<MethodTimerColumns> where, Database db = null)
			{
				return Brevitee.Analytics.MethodTimer.Count(where, db);
			}
	}
	...
	public class LoadTimerQueryContext
	{
			...
			{
				return Brevitee.Analytics.LoadTimer.Where(where, db);
			}
			...
			{
				return Brevitee.Analytics.LoadTimer.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<LoadTimerColumns> where, Database db = null)
			{
				return Brevitee.Analytics.LoadTimer.Count(where, db);
			}
	}
	...
	public class CustomTimerQueryContext
	{
			...
			{
				return Brevitee.Analytics.CustomTimer.Where(where, db);
			}
			...
			{
				return Brevitee.Analytics.CustomTimer.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<CustomTimerColumns> where, Database db = null)
			{
				return Brevitee.Analytics.CustomTimer.Count(where, db);
			}
	}
	...
	public class CounterQueryContext
	{
			...
			{
				return Brevitee.Analytics.Counter.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<CounterColumns> where, Database db = null)
			{
				return Brevitee.Analytics.Counter.Count(where, db);
			}
	}
	...
	public class MethodCounterQueryContext
	{
			...
			{
				return Brevitee.Analytics.MethodCounter.Where(where, db);
			}
			...
			{
				return Brevitee.Analytics.MethodCounter.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<MethodCounterColumns> where, Database db = null)
			{
				return Brevitee.Analytics.MethodCounter.Count(where, db);
			}
	}
	...
	public class LoadCounterQueryContext
	{
			...
			{
				return Brevitee.Analytics.LoadCounter.Where(where, db);
			}
			...
			{
				return Brevitee.Analytics.LoadCounter.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<LoadCounterColumns> where, Database db = null)
			{
				return Brevitee.Analytics.LoadCounter.Count(where, db);
			}
	}
	...
	public class UserIdentifierQueryContext
	{
			...
			{
				return Brevitee.Analytics.UserIdentifier.Where(where, db);
			}
			...
			{
				return Brevitee.Analytics.UserIdentifier.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<UserIdentifierColumns> where, Database db = null)
			{
				return Brevitee.Analytics.UserIdentifier.Count(where, db);
			}
	}
	...
	public class ClickCounterQueryContext
	{
			...
			{
				return Brevitee.Analytics.ClickCounter.Where(where, db);
			}
			...
			{
				return Brevitee.Analytics.ClickCounter.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ClickCounterColumns> where, Database db = null)
			{
				return Brevitee.Analytics.ClickCounter.Count(where, db);
			}
	}
	...
	public class LoginCounterQueryContext
	{
			...
			{
				return Brevitee.Analytics.LoginCounter.Where(where, db);
			}
			...
			{
				return Brevitee.Analytics.LoginCounter.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<LoginCounterColumns> where, Database db = null)
			{
				return Brevitee.Analytics.LoginCounter.Count(where, db);
			}
	}
	...
	public class ImageTagQueryContext
	{
			...
			{
				return Brevitee.Analytics.ImageTag.Where(where, db);
			}
			...
			{
				return Brevitee.Analytics.ImageTag.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ImageTagColumns> where, Database db = null)
			{
				return Brevitee.Analytics.ImageTag.Count(where, db);
			}
	}
