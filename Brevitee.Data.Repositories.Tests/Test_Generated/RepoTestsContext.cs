...
﻿
	public class MainObjectQueryContext
	{
			...
			{
				return Brevitee.Data.Repositories.Tests.MainObject.Where(where, db);
			}
			...
			{
				return Brevitee.Data.Repositories.Tests.MainObject.Where(where, orderBy, db);
			}

			public MainObject OneWhere(WhereDelegate<MainObjectColumns> where, Database db = null)
			{
				return Brevitee.Data.Repositories.Tests.MainObject.OneWhere(where, db);
			}
		
			public MainObject FirstOneWhere(WhereDelegate<MainObjectColumns> where, Database db = null)
			{
				return Brevitee.Data.Repositories.Tests.MainObject.FirstOneWhere(where, db);
			}

			public MainObjectCollection Top(int count, WhereDelegate<MainObjectColumns> where, Database db = null)
			{
				return Brevitee.Data.Repositories.Tests.MainObject.Top(count, where, db);
			}
			...
			{
				return Brevitee.Data.Repositories.Tests.MainObject.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<MainObjectColumns> where, Database db = null)
			{
				return Brevitee.Data.Repositories.Tests.MainObject.Count(where, db);
			}
	}
	...
	public class SecondaryObjectQueryContext
	{
			...
			{
				return Brevitee.Data.Repositories.Tests.SecondaryObject.Where(where, db);
			}
			...
			{
				return Brevitee.Data.Repositories.Tests.SecondaryObject.Where(where, orderBy, db);
			}

			public SecondaryObject OneWhere(WhereDelegate<SecondaryObjectColumns> where, Database db = null)
			{
				return Brevitee.Data.Repositories.Tests.SecondaryObject.OneWhere(where, db);
			}
		
			public SecondaryObject FirstOneWhere(WhereDelegate<SecondaryObjectColumns> where, Database db = null)
			{
				return Brevitee.Data.Repositories.Tests.SecondaryObject.FirstOneWhere(where, db);
			}

			public SecondaryObjectCollection Top(int count, WhereDelegate<SecondaryObjectColumns> where, Database db = null)
			{
				return Brevitee.Data.Repositories.Tests.SecondaryObject.Top(count, where, db);
			}
			...
			{
				return Brevitee.Data.Repositories.Tests.SecondaryObject.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<SecondaryObjectColumns> where, Database db = null)
			{
				return Brevitee.Data.Repositories.Tests.SecondaryObject.Count(where, db);
			}
	}
	...
	public class TernaryObjectQueryContext
	{
			...
			{
				return Brevitee.Data.Repositories.Tests.TernaryObject.Where(where, db);
			}
			...
			{
				return Brevitee.Data.Repositories.Tests.TernaryObject.Where(where, orderBy, db);
			}

			public TernaryObject OneWhere(WhereDelegate<TernaryObjectColumns> where, Database db = null)
			{
				return Brevitee.Data.Repositories.Tests.TernaryObject.OneWhere(where, db);
			}
		
			public TernaryObject FirstOneWhere(WhereDelegate<TernaryObjectColumns> where, Database db = null)
			{
				return Brevitee.Data.Repositories.Tests.TernaryObject.FirstOneWhere(where, db);
			}

			public TernaryObjectCollection Top(int count, WhereDelegate<TernaryObjectColumns> where, Database db = null)
			{
				return Brevitee.Data.Repositories.Tests.TernaryObject.Top(count, where, db);
			}
			...
			{
				return Brevitee.Data.Repositories.Tests.TernaryObject.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<TernaryObjectColumns> where, Database db = null)
			{
				return Brevitee.Data.Repositories.Tests.TernaryObject.Count(where, db);
			}
	}
	...
	public class SecondaryObjectTernaryObjectQueryContext
	{
			...
			{
				return Brevitee.Data.Repositories.Tests.SecondaryObjectTernaryObject.Where(where, db);
			}
			...
			{
				return Brevitee.Data.Repositories.Tests.SecondaryObjectTernaryObject.Where(where, orderBy, db);
			}

			public SecondaryObjectTernaryObject OneWhere(WhereDelegate<SecondaryObjectTernaryObjectColumns> where, Database db = null)
			{
				return Brevitee.Data.Repositories.Tests.SecondaryObjectTernaryObject.OneWhere(where, db);
			}
			...
			{
				return Brevitee.Data.Repositories.Tests.SecondaryObjectTernaryObject.FirstOneWhere(where, db);
			}
			...
			{
				return Brevitee.Data.Repositories.Tests.SecondaryObjectTernaryObject.Top(count, where, db);
			}
			...
			{
				return Brevitee.Data.Repositories.Tests.SecondaryObjectTernaryObject.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<SecondaryObjectTernaryObjectColumns> where, Database db = null)
			{
				return Brevitee.Data.Repositories.Tests.SecondaryObjectTernaryObject.Count(where, db);
			}
	}
