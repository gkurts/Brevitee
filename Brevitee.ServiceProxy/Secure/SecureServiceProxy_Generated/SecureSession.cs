...
﻿	// property:TimeOffset, columnName:TimeOffset	
	[Brevitee.Data.Column(Name="TimeOffset", DbDataType="Int", MaxLength="10", AllowNull=false)]
...
﻿	// start ApplicationId -> ApplicationId
	...
	public Application ApplicationOfApplicationId
	{
		get
		{
			...
			{
				_applicationOfApplicationId = Brevitee.ServiceProxy.Secure.Application.OneWhere(c => c.KeyColumn == this.ApplicationId);
			}
