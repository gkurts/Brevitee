...
﻿
	public class ApplicationQueryContext
	{
			...
			{
				return Brevitee.ServiceProxy.Secure.Application.Where(where, db);
			}
			...
			{
				return Brevitee.ServiceProxy.Secure.Application.Where(where, orderBy, db);
			}

			public Application OneWhere(WhereDelegate<ApplicationColumns> where, Database db = null)
			{
				return Brevitee.ServiceProxy.Secure.Application.OneWhere(where, db);
			}
		
			public Application FirstOneWhere(WhereDelegate<ApplicationColumns> where, Database db = null)
			{
				return Brevitee.ServiceProxy.Secure.Application.FirstOneWhere(where, db);
			}

			public ApplicationCollection Top(int count, WhereDelegate<ApplicationColumns> where, Database db = null)
			{
				return Brevitee.ServiceProxy.Secure.Application.Top(count, where, db);
			}
			...
			{
				return Brevitee.ServiceProxy.Secure.Application.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ApplicationColumns> where, Database db = null)
			{
				return Brevitee.ServiceProxy.Secure.Application.Count(where, db);
			}
	}
	...
	public class SecureSessionQueryContext
	{
			...
			{
				return Brevitee.ServiceProxy.Secure.SecureSession.Where(where, db);
			}
			...
			{
				return Brevitee.ServiceProxy.Secure.SecureSession.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<SecureSessionColumns> where, Database db = null)
			{
				return Brevitee.ServiceProxy.Secure.SecureSession.Count(where, db);
			}
	}
