...
namespace Brevitee
{
    public static class Extensions
    {
		...
		public static object ToDynamicInstance(this DataRow row)
		{
			...
			return ToDynamicInstance(row, typeName);
		}

        /// <summary>
        /// Converts a DataRow to a dynamic object instance.  This implementation
		...
		public static List<object> ToDynamicList(this DataTable table, string typeName)
		{
			List<object> instances = new List<object>();
			foreach(DataRow row in table.Rows)
			{
				instances.Add(row.ToDynamicInstance(typeName));
			}
