...
namespace Brevitee.Logging.Data
{
	...
	public partial class Signature: Dao
	{
		...
		{
﻿
            this.ChildCollections.Add("Event_SignatureId", new EventCollection(Database.GetQuery<EventColumns, Event>((c) => c.SignatureId == this.Id), this, "SignatureId"));							
		}
...
﻿
	...
	public EventCollection EventsBySignatureId
	{
		...
		public static SignatureCollection LoadAll(Database database = null)
		{
			...
			var results = new SignatureCollection(sql.GetDataTable(db));
			results.Database = db;
			return results;
		}
