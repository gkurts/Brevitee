...
﻿
	public class SourceNameQueryContext
	{
			...
			{
				return Brevitee.Logging.Data.SourceName.Where(where, db);
			}
			...
			{
				return Brevitee.Logging.Data.SourceName.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<SourceNameColumns> where, Database db = null)
			{
				return Brevitee.Logging.Data.SourceName.Count(where, db);
			}
	}
	...
	public class UserNameQueryContext
	{
			...
			{
				return Brevitee.Logging.Data.UserName.Where(where, db);
			}
			...
			{
				return Brevitee.Logging.Data.UserName.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<UserNameColumns> where, Database db = null)
			{
				return Brevitee.Logging.Data.UserName.Count(where, db);
			}
	}
	...
	public class CategoryNameQueryContext
	{
			...
			{
				return Brevitee.Logging.Data.CategoryName.Where(where, db);
			}
			...
			{
				return Brevitee.Logging.Data.CategoryName.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<CategoryNameColumns> where, Database db = null)
			{
				return Brevitee.Logging.Data.CategoryName.Count(where, db);
			}
	}
	...
	public class ComputerNameQueryContext
	{
			...
			{
				return Brevitee.Logging.Data.ComputerName.Where(where, db);
			}
			...
			{
				return Brevitee.Logging.Data.ComputerName.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ComputerNameColumns> where, Database db = null)
			{
				return Brevitee.Logging.Data.ComputerName.Count(where, db);
			}
	}
	...
	public class SignatureQueryContext
	{
			...
			{
				return Brevitee.Logging.Data.Signature.Where(where, db);
			}
			...
			{
				return Brevitee.Logging.Data.Signature.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<SignatureColumns> where, Database db = null)
			{
				return Brevitee.Logging.Data.Signature.Count(where, db);
			}
	}
	...
	public class EventParamQueryContext
	{
			...
			{
				return Brevitee.Logging.Data.EventParam.Where(where, db);
			}
			...
			{
				return Brevitee.Logging.Data.EventParam.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<EventParamColumns> where, Database db = null)
			{
				return Brevitee.Logging.Data.EventParam.Count(where, db);
			}
	}
