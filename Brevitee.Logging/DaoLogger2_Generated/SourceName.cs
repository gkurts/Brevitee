...
namespace Brevitee.Logging.Data
{
	...
	public partial class SourceName: Dao
	{
		...
		{
﻿
            this.ChildCollections.Add("Event_SourceNameId", new EventCollection(Database.GetQuery<EventColumns, Event>((c) => c.SourceNameId == this.Id), this, "SourceNameId"));							
		}
...
﻿
	...
	public EventCollection EventsBySourceNameId
	{
		...
		public static SourceNameCollection LoadAll(Database database = null)
		{
			...
			var results = new SourceNameCollection(sql.GetDataTable(db));
			results.Database = db;
			return results;
		}
