...
namespace Brevitee.Logging.Data
{
    ...
    { 
		...
		public LogEventCollection(Database db, DataTable table, Dao dao = null, string rc = null) : base(db, table, dao, rc) { }
		public LogEventCollection(DataTable table, Dao dao = null, string rc = null) : base(table, dao, rc) { }
		public LogEventCollection(Query<LogEventColumns, LogEvent> q, Dao dao = null, string rc = null) : base(q, dao, rc) { }
