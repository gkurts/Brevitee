...
namespace Brevitee.Instructions
{
	...
	[Serializable]
	[Brevitee.Data.Table("InstructionSet", "Instructions")]
	public partial class InstructionSet: Dao
	{
		...
		public InstructionSet(DataRow data): base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		}
		...
		{
﻿
            this.ChildCollections.Add("Section_InstructionSetId", new SectionCollection(Database.GetQuery<SectionColumns, Section>((c) => c.InstructionSetId == this.Id), this, "InstructionSetId"));							
		}
...
﻿	// property:Author, columnName:Author	
	[Brevitee.Data.Column(Name="Author", DbDataType="VarChar", MaxLength="4000", AllowNull=true)]
