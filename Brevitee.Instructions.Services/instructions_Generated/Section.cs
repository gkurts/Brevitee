...
namespace Brevitee.Instructions
{
	...
	[Serializable]
	[Brevitee.Data.Table("Section", "Instructions")]
	public partial class Section: Dao
	{
		...
		public Section(DataRow data): base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		}
...
﻿	// property:Title, columnName:Title	
	[Brevitee.Data.Column(Name="Title", DbDataType="VarChar", MaxLength="4000", AllowNull=false)]
	public string Title
	{
		get
		{
...
﻿	// start InstructionSetId -> InstructionSetId
	...
	public InstructionSet InstructionSetOfInstructionSetId
	{
		get
		{
			...
			{
				_instructionSetOfInstructionSetId = Brevitee.Instructions.InstructionSet.OneWhere(c => c.KeyColumn == this.InstructionSetId);
			}
