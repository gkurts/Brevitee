...
﻿
	...
	public class VaultItemQueryContext
	{
			...
			{
				return Brevitee.Encryption.VaultItem.Where(where, db);
			}
			...
			{
				return Brevitee.Encryption.VaultItem.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<VaultItemColumns> where, Database db = null)
			{
				return Brevitee.Encryption.VaultItem.Count(where, db);
			}
	}
	...
	public class VaultKeyQueryContext
	{
			...
			{
				return Brevitee.Encryption.VaultKey.Where(where, db);
			}
			...
			{
				return Brevitee.Encryption.VaultKey.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<VaultKeyColumns> where, Database db = null)
			{
				return Brevitee.Encryption.VaultKey.Count(where, db);
			}
	}
