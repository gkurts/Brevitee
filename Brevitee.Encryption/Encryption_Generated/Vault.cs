...
namespace Brevitee.Encryption
{
	...
	public partial class Vault: Dao
	{
		...
		{
﻿
            this.ChildCollections.Add("VaultItem_VaultId", new VaultItemCollection(Database.GetQuery<VaultItemColumns, VaultItem>((c) => c.VaultId == this.Id), this, "VaultId"));	﻿
            this.ChildCollections.Add("VaultKey_VaultId", new VaultKeyCollection(Database.GetQuery<VaultKeyColumns, VaultKey>((c) => c.VaultId == this.Id), this, "VaultId"));							
		}
