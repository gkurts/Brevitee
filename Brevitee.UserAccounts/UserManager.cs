...
namespace Brevitee.UserAccounts
{
    ...
    public class UserManager: IRequiresHttpContext
    {
        ...
        protected internal IApplicationNameProvider ApplicationNameResolver
        {
            get
            {
...
";
        ...
        public ForgotPasswordResponse ForgotPassword(string emailAddress)
        {
            try
            {
                ...
                PasswordResetEmailData data = new PasswordResetEmailData
                {
                    ...
                    ApplicationName = ApplicationNameResolver.GetApplicationName(),
        ...
        public SignUpResponse SignUp(string emailAddress, string userName, string passHash, bool sendConfirmationEmail)
        {
            try
            {
                IApplicationNameProvider appNameResolver = ApplicationNameResolver;
        ...
        public SendEmailResponse RequestConfirmationEmail(string emailAddress, int accountIndex = 0)
        {
            try
            {
                ...
                {
                    account = Account.Create(user, ApplicationNameResolver.GetApplicationName(), user.UserName, false);
                }
