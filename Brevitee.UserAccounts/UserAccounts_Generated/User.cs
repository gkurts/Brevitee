...
namespace Brevitee.UserAccounts.Data
{
	...
	public partial class User: Dao
	{
		...
		{
﻿
            this.ChildCollections.Add("Account_UserId", new AccountCollection(Database.GetQuery<AccountColumns, Account>((c) => c.UserId == this.Id), this, "UserId"));	﻿
            this.ChildCollections.Add("Password_UserId", new PasswordCollection(Database.GetQuery<PasswordColumns, Password>((c) => c.UserId == this.Id), this, "UserId"));	﻿
            this.ChildCollections.Add("PasswordReset_UserId", new PasswordResetCollection(Database.GetQuery<PasswordResetColumns, PasswordReset>((c) => c.UserId == this.Id), this, "UserId"));	﻿
            this.ChildCollections.Add("PasswordFailure_UserId", new PasswordFailureCollection(Database.GetQuery<PasswordFailureColumns, PasswordFailure>((c) => c.UserId == this.Id), this, "UserId"));	﻿
            this.ChildCollections.Add("LockOut_UserId", new LockOutCollection(Database.GetQuery<LockOutColumns, LockOut>((c) => c.UserId == this.Id), this, "UserId"));	﻿
            this.ChildCollections.Add("Login_UserId", new LoginCollection(Database.GetQuery<LoginColumns, Login>((c) => c.UserId == this.Id), this, "UserId"));	﻿
            this.ChildCollections.Add("PasswordQuestion_UserId", new PasswordQuestionCollection(Database.GetQuery<PasswordQuestionColumns, PasswordQuestion>((c) => c.UserId == this.Id), this, "UserId"));	﻿
            this.ChildCollections.Add("Setting_UserId", new SettingCollection(Database.GetQuery<SettingColumns, Setting>((c) => c.UserId == this.Id), this, "UserId"));	﻿
            this.ChildCollections.Add("Session_UserId", new SessionCollection(Database.GetQuery<SessionColumns, Session>((c) => c.UserId == this.Id), this, "UserId"));	﻿
            this.ChildCollections.Add("UserRole_UserId", new UserRoleCollection(Database.GetQuery<UserRoleColumns, UserRole>((c) => c.UserId == this.Id), this, "UserId"));				﻿
