...
﻿
	...
	public class AccountQueryContext
	{
			...
			{
				return Brevitee.UserAccounts.Data.Account.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<AccountColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.Account.Count(where, db);
			}
	}
	...
	public class PasswordQueryContext
	{
			...
			{
				return Brevitee.UserAccounts.Data.Password.Where(where, db);
			}
			...
			{
				return Brevitee.UserAccounts.Data.Password.Where(where, orderBy, db);
			}

			public Password OneWhere(WhereDelegate<PasswordColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.Password.OneWhere(where, db);
			}
		
			public Password FirstOneWhere(WhereDelegate<PasswordColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.Password.FirstOneWhere(where, db);
			}

			public PasswordCollection Top(int count, WhereDelegate<PasswordColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.Password.Top(count, where, db);
			}
			...
			{
				return Brevitee.UserAccounts.Data.Password.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<PasswordColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.Password.Count(where, db);
			}
	}
	...
	public class PasswordResetQueryContext
	{
			...
			{
				return Brevitee.UserAccounts.Data.PasswordReset.Where(where, db);
			}
			...
			{
				return Brevitee.UserAccounts.Data.PasswordReset.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<PasswordResetColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.PasswordReset.Count(where, db);
			}
	}
	...
	public class PasswordFailureQueryContext
	{
			...
			{
				return Brevitee.UserAccounts.Data.PasswordFailure.Where(where, db);
			}
			...
			{
				return Brevitee.UserAccounts.Data.PasswordFailure.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<PasswordFailureColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.PasswordFailure.Count(where, db);
			}
	}
	...
	public class LockOutQueryContext
	{
			...
			{
				return Brevitee.UserAccounts.Data.LockOut.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<LockOutColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.LockOut.Count(where, db);
			}
	}
	...
	public class PasswordQuestionQueryContext
	{
			...
			{
				return Brevitee.UserAccounts.Data.PasswordQuestion.Where(where, db);
			}
			...
			{
				return Brevitee.UserAccounts.Data.PasswordQuestion.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<PasswordQuestionColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.PasswordQuestion.Count(where, db);
			}
	}
	...
	public class SettingQueryContext
	{
			...
			{
				return Brevitee.UserAccounts.Data.Setting.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<SettingColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.Setting.Count(where, db);
			}
	}
	...
	public class SessionQueryContext
	{
			...
			{
				return Brevitee.UserAccounts.Data.Session.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<SessionColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.Session.Count(where, db);
			}
	}
	...
	public class SessionStateQueryContext
	{
			...
			{
				return Brevitee.UserAccounts.Data.SessionState.Where(where, db);
			}
			...
			{
				return Brevitee.UserAccounts.Data.SessionState.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<SessionStateColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.SessionState.Count(where, db);
			}
	}
	...
	public class UserBehaviorQueryContext
	{
			...
			{
				return Brevitee.UserAccounts.Data.UserBehavior.Where(where, db);
			}
			...
			{
				return Brevitee.UserAccounts.Data.UserBehavior.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<UserBehaviorColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.UserBehavior.Count(where, db);
			}
	}
	...
	public class UserRoleQueryContext
	{
			...
			{
				return Brevitee.UserAccounts.Data.UserRole.Where(where, db);
			}
			...
			{
				return Brevitee.UserAccounts.Data.UserRole.Where(where, orderBy, db);
			}

			public UserRole OneWhere(WhereDelegate<UserRoleColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.UserRole.OneWhere(where, db);
			}
		
			public UserRole FirstOneWhere(WhereDelegate<UserRoleColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.UserRole.FirstOneWhere(where, db);
			}

			public UserRoleCollection Top(int count, WhereDelegate<UserRoleColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.UserRole.Top(count, where, db);
			}
			...
			{
				return Brevitee.UserAccounts.Data.UserRole.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<UserRoleColumns> where, Database db = null)
			{
				return Brevitee.UserAccounts.Data.UserRole.Count(where, db);
			}
	}
